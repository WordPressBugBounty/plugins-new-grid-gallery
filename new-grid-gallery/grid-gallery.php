...
if ( ! class_exists( 'Awl_Grid_Gallery' ) ) {
	...
	class Awl_Grid_Gallery {
		...
		public function gg_upgrade_pro() { ?>
			...
			<a href="https://awplife.com/demo/grid-gallery-premium/" target="_new" class="button button-primary button-large" style="background: #496481; text-shadow: none; margin-top:10px"><span class="dashicons dashicons-search" style="line-height:1.4;" ></span> <?php esc_html_e( 'Live Demo', 'new-grid-gallery' ); ?></a>
			<a href="https://awplife.com/wordpress-plugins/grid-gallery-wordpress-plugin/" target="_new" class="button button-primary button-large" style="background: #496481; text-shadow: none; margin-top:10px"><span class="dashicons dashicons-unlock" style="line-height:1.4;" ></span> <?php esc_html_e( 'Upgrade Pro', 'new-grid-gallery' ); ?></a>
			<?php
		}
		...
		public function gg_upload_multiple_images( $post ) {
			...
			<div name="add-new-slider" id="add-new-slider" class="new-slider" style="height: 200px; width: 205px; border-radius: 20px;">
				<div class="menu-icon dashicons dashicons-format-image"></div>
					<div class="add-text">
						<?php esc_html_e( 'Add Image', 'new-grid-gallery' ); ?>
