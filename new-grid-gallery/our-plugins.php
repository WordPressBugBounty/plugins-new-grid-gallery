...
<div class="wrap ig-our-plugins-wrap">
    <header class="ig-our-plugins-header">
        <div class="ig-header-content">
            <h1><?php esc_html_e( 'Our WordPress Ecosystem', 'new-grid-gallery' ); ?></h1>
            <p><?php esc_html_e( 'Discover powerful tools designed to simplify your WordPress workflow. High-performance plugins built by A WP Life.', 'new-grid-gallery' ); ?></p>
        </div>
        <div class="ig-header-stats">
            <div class="ig-stat-item">
                <span class="ig-stat-value">500k+</span>
                <span class="ig-stat-label"><?php esc_html_e( 'Active Installs', 'new-grid-gallery' ); ?></span>
            </div>
        </div>
    </header>
    ...
    <nav class="ig-plugins-filters">
        <button class="ig-filter-btn active" data-filter="all"><?php esc_html_e( 'All Plugins', 'new-grid-gallery' ); ?></button>
        <button class="ig-filter-btn" data-filter="new"><?php esc_html_e( 'New Releases', 'new-grid-gallery' ); ?></button>
        <button class="ig-filter-btn" data-filter="popular"><?php esc_html_e( 'Most Popular', 'new-grid-gallery' ); ?></button>
        <button class="ig-filter-btn" data-filter="marketing"><?php esc_html_e( 'Marketing & Growth', 'new-grid-gallery' ); ?></button>
        <button class="ig-filter-btn" data-filter="social"><?php esc_html_e( 'Social Media', 'new-grid-gallery' ); ?></button>
        <button class="ig-filter-btn" data-filter="technical"><?php esc_html_e( 'Technical Tools', 'new-grid-gallery' ); ?></button>
        
        <a href="<?php echo esc_url( wp_nonce_url( add_query_arg( 'refresh_plugins', '1' ), 'ig_refresh_plugins' ) ); ?>" class="ig-refresh-link" title="<?php esc_attr_e( 'Sync with WordPress.org', 'new-grid-gallery' ); ?>">
	...
	<?php if ( empty( $filtered_plugins ) ) : ?>
        <div class="ig-error-wrap">
            ...
            <h2><?php esc_html_e( 'Unable to fetch our plugins', 'new-grid-gallery' ); ?></h2>
            <p><?php esc_html_e( 'We encountered an error connecting to WordPress.org. Please try again later.', 'new-grid-gallery' ); ?></p>
            <a href="<?php echo esc_url( 'https://profiles.wordpress.org/awordpresslife/#content-plugins' ); ?>" target="_blank" class="ig-btn ig-btn-primary" style="margin-top: 20px;">
				<?php esc_html_e( 'Visit Our WordPress Profile', 'new-grid-gallery' ); ?>
            </a>
        </div>
	<?php else : ?>
        <div class="ig-plugins-grid" id="ig-plugins-container">
			<?php foreach ( $filtered_plugins as $plugin ) :
                ...
                <div class="ig-plugin-card <?php echo esc_attr( $cat_classes ); ?>">
					<?php if ( $is_installed ) : ?>
                        <div class="ig-plugin-status"><?php esc_html_e( 'INSTALLED', 'new-grid-gallery' ); ?></div>
					<?php endif; ?>
                    ...
                    <div class="ig-plugin-content">
                        ...
                        <div class="ig-plugin-meta">
                            ...
                            <div class="ig-plugin-meta-item">
								...
								<?php echo esc_html( $install_count ); ?> <?php esc_html_e( 'Installs', 'new-grid-gallery' ); ?>
                            </div>
                        </div>
                        ...
                        <div class="ig-plugin-actions">
                            <a href="<?php echo esc_url( 'https://wordpress.org/plugins/' . $plugin['slug'] . '/' ); ?>" target="_blank" class="ig-btn ig-btn-secondary">
								<?php esc_html_e( 'Details', 'new-grid-gallery' ); ?>
                            </a>
                            <a href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=plugin-information&plugin=' . $plugin['slug'] . '&TB_iframe=true&width=772&height=550' ) ); ?>" class="ig-btn ig-btn-primary thickbox">
								<?php esc_html_e( 'Install Now', 'new-grid-gallery' ); ?>
                            </a>
                        </div>
                    </div>
                </div>
